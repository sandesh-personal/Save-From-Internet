...
import { instagramPostContentData } from '@/lib/platformTranslations'

export default function InstagramPostContent() {
  const { lang } = useLanguage()
  const data = instagramPostContentData[lang] || instagramPostContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-white border border-slate-200 shadow-xs p-6 sm:p-10">
            <div className="relative text-center">
              ...
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-slate-900 mb-3 tracking-tight">
                {data.heroTitle} — Full HD 1080p &amp; ZIP
              </h2>
      ...
      <RelatedBlogs
        ...
        title="Related Instagram Photo & Post Guides"
        subtitle="Explore our helpful tutorials on saving Instagram photos, carousel albums, and HD images."
      />
