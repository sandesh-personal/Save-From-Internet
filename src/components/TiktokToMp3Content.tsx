...
import { MusicIcon, CheckCircleIcon } from '@/components/icons'
import { useLanguage } from '@/contexts/LanguageContext'
import { tiktokToMp3ContentData } from '@/lib/platformTranslations'

export default function TiktokToMp3Content() {
  const { lang } = useLanguage()
  const data = tiktokToMp3ContentData[lang] || tiktokToMp3ContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <RelatedBlogs
        platform="tiktok"
        title="Related TikTok Audio & MP3 Guides"
        subtitle="Explore our helpful tutorials on extracting audio, making ringtones, and saving TikTok sounds."
      />
