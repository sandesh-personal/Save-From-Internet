...
import { tiktokContentData } from '@/lib/platformTranslations'

export default function HomeContent() {
  const { lang } = useLanguage()
  const data = tiktokContentData[lang] || tiktokContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <RelatedBlogs
        platform="tiktok"
        title="Latest Blog Articles &amp; Guides"
        subtitle="Explore our helpful tutorials on saving TikTok videos, removing watermarks, extracting MP3 audio, and downloading carousels."
      />
