...
import { PhotoIcon, CheckCircleIcon } from '@/components/icons'
import { useLanguage } from '@/contexts/LanguageContext'
import { tiktokPhotoContentData } from '@/lib/platformTranslations'

export default function TiktokPhotoContent() {
  const { lang } = useLanguage()
  const data = tiktokPhotoContentData[lang] || tiktokPhotoContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <RelatedBlogs
        platform="tiktok"
        title="Related TikTok Photo & Slideshow Guides"
        subtitle="Explore our helpful tutorials on saving TikTok photo posts, carousel images, and background sounds."
      />
