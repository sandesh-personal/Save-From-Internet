    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between gap-3">
          ...
          {/* Right: Install App + Language + Hamburger */}
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-2.5 sm:px-3 py-1.5 bg-slate-100 hover:bg-slate-200 active:bg-slate-300 text-slate-900 font-bold text-xs rounded-xl border border-slate-300 transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs select-none"
              title="Install SaveFromInternet App"
            >
