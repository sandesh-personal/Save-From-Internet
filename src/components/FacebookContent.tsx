...
import { facebookContentData } from '@/lib/platformTranslations'

export default function FacebookContent() {
  const { lang } = useLanguage()
  const data = facebookContentData[lang] || facebookContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <RelatedBlogs
        platform="facebook"
        title="Related Facebook Download Guides"
        subtitle="Explore our helpful tutorials on saving Facebook videos, Reels, and clips."
      />
