...
import { twitterContentData } from '@/lib/platformTranslations'

export default function TwitterContent() {
  const { lang } = useLanguage()
  const data = twitterContentData[lang] || twitterContentData.en
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <RelatedBlogs
        platform="twitter"
        title="Related Twitter (X) Download Guides"
        subtitle="Explore our helpful tutorials on saving Twitter / X videos and animated GIFs."
      />
