      ...
      <div className="max-w-4xl mx-auto space-y-8 text-sm leading-relaxed">
        ...
        <div className="space-y-8">
          ...
          <div className="mt-6 space-y-4">
            ...
            <p>Open any browser (Chrome, Safari, Firefox, Brave) and go to <a href="https://savefrominternet.com" target="_blank" className="text-blue-600 underline">savefrominternet.com</a>. Paste your copied link into the input bar and click "Process TikTok URL".</p>
            ...
            <ul className="list-disc pl-6">
              <li><strong>Video:</strong> Download high-quality video with no watermark.</li>
              <li><strong>Audio:</strong> Extract MP3 audio from TikTok (perfect for background music or reuse).</li>
              <li><strong>Image:</strong> For image carousel posts, download the full set or select just one image.</li>
            </ul>
            <p>Photos are saved in a ZIP file to preserve quality, or you can download single images easily.</p>

            <h3 className="text-lg font-semibold mt-4">📥 Step 5: Click Video or Audio As Per Your Requirements </h3>
            <Image src="/images/step5.jpg" alt="download tiktok videos without watermark 2025 final step" width={200} height={100} className="w-100 rounded-lg" />
            <p>After selecting your format, click the download button. Your content is saved instantly — ad-free, watermark-free, and without quality loss.</p>
            ...
            <table className="w-full text-sm border border-gray-200 mt-2">
              <thead>
                <tr className="bg-gray-100">
                  ...
                  <th className="p-2 text-center">snaptik.app</th>
                </tr>
              </thead>
              <tbody>
            ...
            <ul className="list-disc pl-6">
              <li><Link href="/#extract-audio" className="text-blue-600 underline">Extract only audio</Link></li>
              <li><Link href="/#photo-zip" className="text-blue-600 underline">Download TikTok photos as ZIP</Link></li>
              <li><Link href="/#extension" className="text-blue-600 underline">SaveFromInternet Chrome Extension (coming soon)</Link></li>
            </ul>

            <h3 className="text-lg font-semibold mt-4">📎 Related Tools (With Limitations)</h3>
            <ul className="list-disc pl-6">
              <li><a href="https://ssstik.io" target="_blank" className="text-blue-600 underline">ssstik.io</a> – Free but ad-heavy</li>
              <li><a href="https://snaptik.app" target="_blank" className="text-blue-300 underline">snaptik.app</a> – Frequently down during peak hours</li>
            ...
            <p>🔗 Try it now: <a href="https://savefrominternet.com" target="_blank" className="text-blue-600 underline">https://savefrominternet.com</a></p>
          </div>
