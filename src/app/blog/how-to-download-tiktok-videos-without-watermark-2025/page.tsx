        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="mt-6 text-white space-y-4">
              ...
              <Image src="/images/step1.jpg" alt="Open TikTok" width={400} height={200} className="w-100 rounded-lg"  />
              ...
              <Image src="/images/step2.jpg" alt="Copy TikTok link" width={400} height={200} className="w-100 rounded-lg" />
              ...
              <Image src="/images/step3.jpg" alt="Paste TikTok link" width={400} height={200} className="w-100 rounded-lg" />
              ...
              <Image src="/images/step4.jpg" alt="Download options" width={200} height={100} className="w-100 rounded-lg" />
              <ul className="list-disc pl-6">
              ...
              <Image src="/images/step5.jpg" alt="Final download step" width={200} height={100} className="w-100 rounded-lg" />
              ...
              <ul className="list-disc pl-6">
                <li><a href="https://ssstik.io" target="_blank" className="text-blue-300 underline">ssstik.io</a> – Free but ad-heavy</li>
