    ...
    <div className="min-h-[calc(100vh-6rem)] px-4 py-8 bg-gradient-to-br from-black via-gray-900 to-black text-white">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">How to Download TikTok Videos</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-white/70 text-sm">Copy the link from any TikTok video you want to download</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500/20 to-violet-500/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-pink-500/30">
            ...
            <div className="text-center">
              ...
              <h3 className="text-white font-semibold mb-2">Download Content</h3>
              <p className="text-white/70 text-sm">Choose to download video, audio, or images in high quality</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center bg-gradient-to-br from-pink-500/10 to-violet-500/10 rounded-lg p-4 border border-pink-500/20">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Video Download</h3>
              <p className="text-white/70 text-sm">Download TikTok videos in HD quality without watermark as MP4 files</p>
            </div>
            <div className="text-center bg-gradient-to-br from-green-500/10 to-blue-500/10 rounded-lg p-4 border border-green-500/20">
              <div className="text-3xl mb-3">🎵</div>
              <h3 className="text-lg font-semibold text-white mb-2">Audio Extraction</h3>
              <p className="text-white/70 text-sm">Extract high-quality MP3 audio from TikTok videos for music and sounds</p>
            </div>
            <div className="text-center bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-lg p-4 border border-purple-500/20">
              ...
              <p className="text-white/70 text-sm">Download multiple images from TikTok posts individually or as ZIP</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/5 rounded-xl p-6 border border-white/10">
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Is downloading TikTok videos legal?</h3>
              <p className="text-white/70">Downloading your own TikTok videos or public videos for personal use is generally legal. Always respect copyright laws and creator rights.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">What video quality will I get?</h3>
              <p className="text-white/70">We provide the highest quality available from the original TikTok video, typically 720p or 1080p HD resolution.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Do I need to install any software?</h3>
              <p className="text-white/70">No! Our TikTok downloader works entirely in your web browser. No downloads, installations, or registrations required.</p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Can I download private TikTok videos?</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Are there any download limits?</h3>
              <p className="text-white/70">No! You can download unlimited TikTok videos, audio, and images without any restrictions or limits.</p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-pink-500/10 to-violet-500/10 rounded-xl p-8 border border-pink-500/20">
          <h2 className="text-2xl font-bold text-white mb-4">Ready to Download TikTok Videos?</h2>
          <p className="text-white/80 mb-6">Start downloading your favorite TikTok videos without watermark right now!</p>
          <Link 
            href="/" 
            className="inline-block bg-gradient-to-r from-pink-500 to-violet-500 text-white font-semibold px-8 py-3 rounded-xl hover:from-pink-600 hover:to-violet-600 transition-all duration-200 text-lg"
          >
