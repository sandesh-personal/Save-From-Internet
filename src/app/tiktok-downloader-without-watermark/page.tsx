    ...
    <div className="bg-white dark:bg-slate-900">
      ...
      <section className="bg-gradient-to-b from-indigo-50/50 dark:from-slate-800 to-white dark:to-slate-900 py-14 px-4 text-center border-b border-slate-100 dark:border-slate-700/50">
        <div className="max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white dark:bg-slate-800 text-indigo-500 text-xs font-semibold px-4 py-1.5 rounded-full mb-5 border border-indigo-100 dark:border-indigo-900/40 shadow-sm">Zero Watermark Guarantee</div>
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-4 leading-tight">
            TikTok Downloader{' '}
            <span className="text-indigo-500">Without Watermark</span>
          </h1>
          <p className="text-lg text-slate-500 dark:text-slate-400 mb-8 max-w-xl mx-auto">Download TikTok videos without the TikTok watermark in HD quality. Free, no app, no sign-up. Works everywhere.</p>
      ...
      <section className="bg-slate-50 dark:bg-slate-800/50 py-14 px-4 border-b border-slate-100 dark:border-slate-700/50">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white text-center mb-6">Why Our Downloads Have No Watermark</h2>
          <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-100 dark:border-slate-700/50 shadow-sm space-y-4 text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            <p><strong className="text-slate-900 dark:text-white">SaveFromInternet.com fetches the original video file directly from TikTok&apos;s servers</strong> before any watermark is applied. The result: a clean, watermark-free MP4 at original HD quality.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-slate-900 py-14 px-4 border-b border-slate-100 dark:border-slate-700/50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white text-center mb-10">How to Download Without Watermark</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={n} className="bg-slate-50 dark:bg-slate-800 rounded-lg p-6 border border-slate-100 dark:border-slate-700/50 text-center">
      ...
      <section className="bg-slate-50 dark:bg-slate-800/50 py-14 px-4 border-b border-slate-100 dark:border-slate-700/50">
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-100 dark:border-slate-700/50 shadow-sm">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-5">What You Get</h3>
            <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300">
              {['No TikTok watermark or username overlay','Original HD quality — 720p, 1080p preserved','MP4 format, plays on any device','Also extract MP3 audio watermark-free','Completely free, unlimited downloads'].map((f) => (
                <li key={f} className="flex gap-2"><span className="text-indigo-500 font-bold">✓</span><span>{f}</span></li>
              ))}
            </ul>
          </div>
          <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-slate-100 dark:border-slate-700/50 shadow-sm">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-5">Works On</h3>
            <ul className="space-y-3 text-sm text-slate-600 dark:text-slate-300">
      ...
      <section className="bg-indigo-500 py-14 px-4 text-center">
        <h2 className="text-3xl font-bold text-white mb-4">Download TikTok Without Watermark — Free</h2>
        <p className="text-indigo-100 mb-8 text-lg">Clean HD video. No watermark. No sign-up.</p>
